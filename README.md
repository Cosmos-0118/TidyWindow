...
-   Latest stable: **3.8.4** ([data/catalog/latest-release.json](data/catalog/latest-release.json))
-   Docs: [docs/](docs)
...
See [docs/getting-started.md](docs/getting-started.md) for optional dependencies, troubleshooting, and installer usage. Latest installer: **3.8.4** (stable). Inside the app, open Settings ▸ Updates to read the hosted manifest and jump to the newest release notes without a manual download.
